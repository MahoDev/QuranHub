		...
		<div className="px-8  z-[1] bg-emerald-50 dark:bg-emerald-800 drop-shadow-lg sticky w-full top-0">
			<ul className="flex justify-between items-center pt-4 pb-4 text-emerald-900 dark:text-white">
				<li className="font-extrabold ">
					<Link to="/">
						<span className="text-2xl mx-1">منصة القرآن</span>
								...
								(currentUser != null && currentUser.emailVerified == false) ? (
									<>
										...
										<li>
											<Link
												to="user/signup"
												className="text-white font-bold py-3 px-6 rounded-full bg-emerald-800 hover:bg-emerald-700 dark:bg-amber-500 hover:dark:bg-amber-400"
											>
												تسجيل
											</Link>
										</li>
									...
									<>
										...
										<li
											className="text-white font-bold py-3 px-6 rounded-full cursor-pointer bg-emerald-800 hover:bg-emerald-700 dark:bg-amber-500 hover:dark:bg-amber-400"
											onClick={() => {
												signOut(auth);
											}}
										>
