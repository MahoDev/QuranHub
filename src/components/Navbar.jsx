...
function Navbar({ isDarkMode, onDarkModeChange, currentUser }) {
	...
	return (
		<div className="px-8 z-[1] bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg drop-shadow-lg sticky w-full top-0 border-b border-emerald-200/50 dark:border-emerald-700/50">
				...
				<li className="relative md:flex">
					...
					>
						{menuDisplayed && (
							<ul
								id="menuBox"
								className={`absolute w-[280px] left-0 top-[50px] z-3 flex flex-col items-center gap-4 p-6 bg-white/95 dark:bg-gray-800/95 backdrop-blur-lg border border-emerald-200/50 dark:border-emerald-700/50 shadow-xl rounded-2xl
